...
const paymentMethods = [
  { id: 'orange', name: 'Orange Money', color: 'bg-orange-500', logo: '/payments/orange.png' },
  { id: 'mtn', name: 'MTN MoMo', color: 'bg-yellow-400', logo: '/payments/mtn.jpg' },
  { id: 'moov', name: 'Moov Money', color: 'bg-blue-600', logo: '/payments/moov.png' },
  { id: 'wave', name: 'Wave', color: 'bg-cyan-400', logo: '/payments/wave.png' },
];
          ...
          <div className="md:w-3/5 p-8 relative">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              {paymentMethods.map((method) => (
                ...
                >
                  <div className="w-14 h-14 rounded-xl flex items-center justify-center bg-white shadow-sm overflow-hidden mb-3">
                    <img src={method.logo} alt={method.name} className="w-full h-full object-cover" />
                  </div>
                  <span className="text-[11px] font-black text-gray-700 dark:text-gray-300 text-center uppercase tracking-tighter">{method.name}</span>
                </button>
              ))}
            </div>
